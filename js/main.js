function descobrirCDZ() {
    let dia = parseInt(window.prompt('Digite o dia que você nasceu: '));
    let mes = parseInt(window.prompt('Digite o mês que você nasceu: '));

    const texto = document.querySelector("h1");
    const paragrafo = document.querySelector("p");
    const imagem = document.querySelector("img");

    let data = new Date(2023, mes - 1, dia);
